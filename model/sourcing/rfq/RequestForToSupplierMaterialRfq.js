...
cube(`RequestForToSupplierMaterialRfq`, {
  ...
  measures: {
    count: {
      ...
      description: `Total number of supplier invitations for RFQs`
    },
  ...
  dimensions: {
    ...
    parentId: {
      ...
      type: `string`,
      title: `RFQ ID`,
      description: `Reference to the parent RFQ ID`
    },
    ...
    hasActiveStatusChanged: {
      ...
      description: `Flag indicating if the supplier has viewed or responded to the RFQ`
    }
  }
});
